...
big() ->
  big(erlang:processes(), []).

big([], Acc) ->
  Sorted = lists:sort(fun(I1,I2) -> 
	Mem1 = proplists:get_value(total_heap_size,I1),
	Mem2 = proplists:get_value(total_heap_size,I2),
	Mem1 < Mem2
  end, Acc),
  [I1,I2,I3|_] = lists:reverse(Sorted),
  {I1,I2,I3};
big([Pid|Rest], Acc) ->
  T = [
